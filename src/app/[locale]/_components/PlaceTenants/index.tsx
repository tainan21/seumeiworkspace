  ...
  return (
    <div className="flex w-1/2 items-center justify-center">
      <div className="mt-6 flex flex-row items-center gap-2 rounded-[100px] bg-white bg-opacity-20 px-4 py-2">
        <Image alt="user icon" src="/icons/user.svg" width={16} height={16} />
    ...
    <div className="container mx-auto mt-48">
      ...
      <div className="flex flex-col gap-6 lg:flex-row">
        <div className="rounded-[20px] bg-orange">
          <Block
            title={seumeiTexts.placeTenants.cards[0].title}
            subTitle={seumeiTexts.placeTenants.cards[0].subtitle}
            href={seumeiTexts.placeTenants.cards[0].href}
          />
        </div>
        <div className="rounded-[20px] bg-purple">
          <Block
            title={seumeiTexts.placeTenants.cards[1].title}
            subTitle={seumeiTexts.placeTenants.cards[1].subtitle}
            href={seumeiTexts.placeTenants.cards[1].href}
          />
        </div>
        <div className="rounded-[20px] bg-blue">
          <Block
            title={seumeiTexts.placeTenants.cards[2].title}
            subTitle={seumeiTexts.placeTenants.cards[2].subtitle}
            href={seumeiTexts.placeTenants.cards[2].href}
          />
        </div>
      </div>
    </div>
