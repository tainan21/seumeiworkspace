    ...
    >
      <div className="flex flex-row items-center justify-between">
        <div className="whitespace-nowrap">
          <NewHeading>Built on Seumei</NewHeading>
        </div>
