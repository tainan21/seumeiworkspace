...
const tweets: Tweet[] = [
  ...
  },
  {
    ...
    content:
      'This looks INCREDIBLE!\nI\'ve had the "pleasure" of designing multi-tenant SaaS applications several times in my career. Seumei seems to tackle exactly all the right problems.',
  },
  {
  ...
  },
  {
    ...
    content:
      'I like how the @seumeidatabase positions itself. Not a yet another scalable Postgres database, but a SaaS platform with a lot of built-in integrations (yes also AI) for rapid app development *and* shipping!',
  },
  {
  ...
  },
  {
    ...
    content:
      'There are a lot of Postgres startups out there but Seumei is one of the more interesting things happening in the PG space. To anyone who has worked on some SaaS product, this must look like a no-brainer: multitenant PG.',
  },
];
  ...
  return (
    <div className="mx-auto w-full max-w-7xl px-2 py-6 sm:px-6 sm:py-16">
      <div className="mb-6 flex justify-center sm:mb-12">
        <NewHeading>{seumeiTexts.tweetCarousel.title}</NewHeading>
      </div>
