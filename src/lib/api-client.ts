// ============================================
// API Client - Chamadas para API de workspace
// ============================================
...
export async function createWorkspaceApi(
  input: Omit<CreateWorkspaceInput, "userId">
): Promise<CreateWorkspaceResult> {
  // userId será preenchido pela API via session
  ...
  if (!res.ok) {
    ...
    throw new Error(errorData.errors?.[0]?.message || "Falha ao criar workspace");
  }
  return res.json();
}
