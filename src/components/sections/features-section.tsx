...
export function FeaturesSection() {
  ...
  const tCards = useScopedI18n("features.cards")
  ...
  return (
    <section id="features" className="px-6 py-24">
      <div className="max-w-5xl mx-auto">
        ...
        >
          <p className="text-sm font-medium text-zinc-500 uppercase tracking-wider mb-4">{t("sectionTag")}</p>
            ...
            <Card className="group h-full overflow-hidden border-zinc-800/50 bg-zinc-900/50 hover:border-zinc-700/50 transition-all duration-300 rounded-2xl">
              <CardContent className="p-6">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <p className="font-heading font-semibold text-zinc-100">{tCards("dashboard.title")}</p>
                </div>
                <p className="text-zinc-500 text-sm mb-5">
                  {tCards("dashboard.description")}
                </p>
                <div className="rounded-xl border border-zinc-800 bg-zinc-950 p-4 overflow-hidden">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      >
                        ...
                        <span className="text-xs text-zinc-500">{tCards("dashboard.metrics.users")}</span>
                      </motion.div>
                      <motion.div
                        className="flex items-center gap-1.5"
                        initial={{ opacity: 0 }}
                      ...
                      >
                        ...
                        <span className="text-xs text-zinc-500">{tCards("dashboard.metrics.revenue")}</span>
                      </motion.div>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-3 gap-3 mb-4">
                    {[
                      { label: tCards("dashboard.metrics.totalUsers"), value: "12.4K", change: "+12%" },
                      { label: tCards("dashboard.metrics.revenue"), value: "$48.2K", change: "+8%" },
                      { label: tCards("dashboard.metrics.conversion"), value: "3.2%", change: "+2%" },
                    ].map((metric, i) => (
                      <motion.div
                        key={metric.label}
            ...
            <Card className="group h-full overflow-hidden border-zinc-800/50 bg-zinc-900/50 hover:border-zinc-700/50 transition-all duration-300 rounded-2xl">
              <CardContent className="p-6 flex flex-col h-full">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <p className="font-heading font-semibold text-zinc-100">{tCards("performance.title")}</p>
                </div>
                <p className="text-zinc-500 text-sm mb-5">{tCards("performance.description")}</p>
                <div className="mt-auto">
                  <div className="flex items-baseline gap-2 mb-3">
                    ...
                    <span className="text-zinc-500 text-sm">{tCards("performance.uptime")}</span>
                  </div>
            ...
            <Card className="group h-full overflow-hidden border-zinc-800/50 bg-zinc-900/50 hover:border-zinc-700/50 transition-all duration-300 rounded-2xl">
              <CardContent className="p-6 flex flex-col h-full">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <p className="font-heading font-semibold text-zinc-100">{tCards("keyboard.title")}</p>
                </div>
                <p className="text-zinc-500 text-sm mb-5">{tCards("keyboard.description")}</p>
            ...
            <Card className="group h-full overflow-hidden border-zinc-800/50 bg-zinc-900/50 hover:border-zinc-700/50 transition-all duration-300 rounded-2xl">
              <CardContent className="p-6 flex flex-col h-full">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <p className="font-heading font-semibold text-zinc-100">{tCards("integrations.title")}</p>
                </div>
                <p className="text-zinc-500 text-sm mb-5">{tCards("integrations.description")}</p>
                ...
                >
                  {tCards("integrations.viewAll")} <ArrowRight className="w-4 h-4" />
                </motion.button>
              </CardContent>
            </Card>
          </motion.div>
