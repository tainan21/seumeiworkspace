...
export function ImpactSection() {
  const t = useScopedI18n("impact")
  
  // Define os metrics com valores estáticos e traduções individuais
  const metrics = [
    { 
      value: "99.99%", 
    ...
    <section className="px-6 py-24 bg-zinc-900/20">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <h2 className="font-display text-3xl md:text-4xl font-bold text-zinc-100 mb-4">{t("title")}</h2>
